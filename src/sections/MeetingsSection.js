...
export default function MeetingsSection() {
    return (<section id="meetings">
      <div className="section-shell">
        <SectionTitle eyebrow="Meeting Information" title="Next meeting in Room 129 after school" subtitle="We currently have one confirmed upcoming topic. Check Discord and Google Classroom for schedule updates."/>
        <div className="mx-auto max-w-3xl">
          ...
          <div className="space-y-4">
            {meetings.map(function (meeting) { return (<article key={meeting.id} className="card">
