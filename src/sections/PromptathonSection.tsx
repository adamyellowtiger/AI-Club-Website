  ...
  return (
    <section id="promptathon">
      <div className="section-shell">
        <SectionTitle eyebrow="Featured Event" title={promptathon.title} subtitle={promptathon.subtitle} />

        <div className="mb-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
          {promptathon.details.map((detail) => (
            <article key={detail.label} className="rounded-2xl border border-blue-100 bg-white p-4 shadow-soft">
        ...
        <div className="mb-6 rounded-2xl border border-blue-200 bg-blue-50 px-4 py-3 text-blue-900 shadow-soft">
          <p className="text-sm font-semibold">{promptathon.callout}</p>
        </div>
