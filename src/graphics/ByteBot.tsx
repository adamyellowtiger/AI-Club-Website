...
export default function ByteBot({ className = 'h-44 w-44', pose = 'wave' }: ByteBotProps) {
  const armPath =
    pose === 'point'
  ...
  return (
    <svg viewBox="0 0 320 320" className={className} role="img" aria-label="Byte the Bayview AI Club robot mascot">
      <defs>
