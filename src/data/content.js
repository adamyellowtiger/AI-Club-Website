import { Binary, BrainCircuit, Code2, Compass, ShieldCheck, Sparkles, Users, WandSparkles } from 'lucide-react';
export var navLinks = [
...
export var aiBits = [
    {
        ...
        summary: 'AI does best on tasks with lots of examples, clear patterns, and well-defined success. It struggles more when the work depends on messy context, shifting goals, or human judgment.',
    ...
    },
    {
        ...
        summary: 'The same model can produce different replies because generation is not always fully deterministic, and even tiny context changes can shift the path of the answer.',
    ...
    },
    {
        ...
        summary: 'Recommendation systems try to predict what you are most likely to click, watch, like, or stay with based on patterns in your behavior and the behavior of similar users.',
    ...
    },
    {
        ...
        summary: 'After you press enter, your message gets turned into tokens, combined with the earlier conversation, processed by the model, and answered one token at a time.',
        tags: ['How AI Works', 'Basics'],
        body: [
...
export var promptathon = {
    title: 'Prompt-A-Thon Competition',
    subtitle: 'A team-based AI competition where students use prompt engineering, iteration, and critical thinking to solve real problems.',
    details: [
    ...
    overview: 'A Prompt-A-Thon is a creative problem-solving challenge where teams use strategic prompting with Generative AI to research, iterate, and develop solutions to a central challenge. The event helps students move from passive AI use to active, critical thinking and responsible AI practice.',
...
export var resources = [
    {
        ...
        href: "".concat(import.meta.env.BASE_URL, "resources/AI_Basics_Starter_Guide.pdf")
    },
    ...
    { title: 'Weekly Recap Notes', description: 'Quick summaries for anyone who missed a meeting.', href: '#' },
    {
        ...
        href: "".concat(import.meta.env.BASE_URL, "resources/Useful_Tools_List.pdf")
    },
    {
        title: 'AI Ethics Reading List',
        description: 'Articles and videos to spark thoughtful discussion.',
        href: "".concat(import.meta.env.BASE_URL, "resources/AI_Ethics_Reading_List.pdf")
    },
    {
        title: 'Prompting Cheat Sheet',
        description: 'Tips for clearer prompts and better results.',
        href: "".concat(import.meta.env.BASE_URL, "resources/Prompting_Cheat_Sheet.pdf")
    }
];
export var team = [
    {
